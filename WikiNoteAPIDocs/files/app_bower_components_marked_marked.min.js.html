...
<head>
    <meta charset="utf-8">
    <title>app/bower_components/marked/marked.min.js - WikiNote API</title>
...
<div id="doc">
    <div id="hd" class="yui3-g header">
        <div class="yui3-u-3-4">
            <h1><a href="../index.html"><img src="../assets/css/logo.png" width="117" height="52">WikiNote API: app/bower_components/marked/marked.min.js</a></h1>
        </div>
    ...
    <div class="yui3-g">
        ...
        <div id="main" class="yui3-u">
            <div class="content"><h4>app/bower_components/marked/marked.min.js</h4>
